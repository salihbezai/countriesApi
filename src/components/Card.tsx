...
const Card = ({country}:any) => {
  return (
    <div className='w-full h-full  dark:bg-darkBlueElements  transition-all rounded-md overflow-hidden 
    cursor-pointer shadow-md hover:shadow-lg translate-y-6 hover:scale-105 max-h-[25rem] max-w-sm mx-auto'>
        <img className='w-full h-1/2  object-cover' src={country.flags.svg} alt={country.flags.alt} />
